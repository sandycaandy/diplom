...
<body>
<h2 class="title-login"> Добро пожаловать в систему управления</h2>
...
<form method="post" >
<ul id="pass-login">
<li><label>Логин</label><input class="input-admin" type="text" name="input_login" /></li>
<li><label>Пароль</label><input class="input-admin"  type="password" name="input_pass" /></li>
</ul>
