...
<meta charset="UTF-8">
  ...
  <title>Интернет-магазин постельного белья | Постельное бельё</title>
</head>
<header class="header">
         <?php
...
-->
            ...
            <div class="product__wrapper">
                <ul class="product__list">
                    ...
                    $result = mysql_query("SELECT * FROM table_products WHERE type_tovara='linen' ORDER BY $sorting", $link);
