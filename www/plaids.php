...
<meta charset="UTF-8">
  ...
  <title>Интернет-магазин постельного белья | Пледы</title>
</head>
<header class="header">
         <?php
...
-->
            ...
            <div class="product__wrapper">
                <ul class="product__list">
                    ...
                    $result = mysql_query("SELECT * FROM table_products WHERE type_tovara='plaids' ORDER BY $sorting", $link);
...
';
                        ...
                        echo '<p class="product__nt">Типа товаров не существует!</p>';
                      }
